TASK 00: Create a script that switches the current user to the user betty.
...
TASK 12: Write a script that changes the group owner to school for the file hello.
